...
import smlb
from smlb import InvalidParameterError, params


class WatercolorPigments2019Dataset(smlb.TabularData):
...
class WatercolorPigments2019DatasetFeatures(smlb.Features):
    ...
    def _apply_one_hot(
        ...
        return smlb.TabularData(data=features, labels=labels)

    def apply(self, data: smlb.TabularData) -> smlb.TabularData:
        """Featurize WatercolorPigments2019Dataset."""

        data = params.instance(data, smlb.TabularData)
